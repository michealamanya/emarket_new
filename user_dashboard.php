...
<body>
  <header class="header">
    <div class="container">
      ...
      <h1>JK ONLINE SHOPPERS UGANDA</h1>
      <p>Welcome to your E-Market Center,  <?php echo htmlspecialchars($_SESSION['username']); ?></p>
      <nav>
        <ul>
        <li>
    <a href="#products">
...
<li><a href="support.php"><i class="bi bi-headset"></i> Support</a></li>
  ...
  <section class="products" id="products">
    <div class="container">
      ...
      <div class="product-grid">
        <?php
        // Query to select all products along with their category names
        $query = "
  ...
  <section class="contact" id="contact">
    ...
    <div class="contact-item">
        <h4>Email Us</h4>
        <p>
            <i class="fas fa-envelope" style="font-size: 20px; margin-right: 5px;"></i>
            <a href="mailto:amanyamicheal770@gmail.com">amanyamicheal770@gmail.com</a>
            <span>(Email)</span>
        </p>
    </div>
    <div class="contact-item">
        <h4>Call Us</h4>
        <p>
            <i class="fas fa-phone" style="font-size: 20px; margin-right: 5px;"></i>
            <a href="tel:+256706590566">+256 706 590 566</a>
            <span>(Phone)</span>
        </p>
    </div>
</div>
    ...
    <a href="https://www.facebook.com" target="_blank">
        <i class="fab fa-facebook-square" style="font-size: 40px; margin-right: 10px;"></i>
    </a>
    <a href="https://www.twitter.com" target="_blank">
        <i class="fab fa-twitter-square" style="font-size: 40px; margin-right: 10px;"></i>
    </a>
    <a href="https://www.instagram.com" target="_blank">
        <i class="fab fa-instagram" style="font-size: 40px; margin-right: 10px;"></i>
    </a>
</div>
        </div>
    </div>
